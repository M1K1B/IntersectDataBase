...
korisnik = raw_input("\033[1;37mUsername: \033[1m")
lozinka = raw_input("\033[1;37mPassword: \033[1m")
...
def add():
	userName = raw_input("\033[1;36m   User's name:\033[1m \033[1;37m")
	userLastname = raw_input("\033[1;36m   User's lastname:\033[1m \033[1;37m")
	userBirth = raw_input("\033[1;36m   User's birthday:\033[1m \033[1;37m")
	userAddress = raw_input("\033[1;36m   User's address:\033[1m \033[1;37m")
	userAbout = raw_input("\033[1;36m   About user:\033[1m \033[1;37m")
	userImage = raw_input("\033[1;36m   Do you want to add image(y/n):\033[1m \033[1;37m")
	
	if userImage == "y":
		userImagePath = raw_input("\033[1;36m   Path to image:\033[1m \033[1;37m")
...
def read():
	fileName = raw_input("\033[1;36m   File name:\033[1m \033[1;37m")
	grupa = []
...
def search():
	searchName = raw_input("\033[1;36m   Search for:\033[1m \033[1;37m")
...
def defInput():
	myInput = raw_input("\033[1;37m> \033[1m")
	#help
	if myInput == "help":
